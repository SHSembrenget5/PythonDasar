...
# Entry angka 1
angkal_label = ttk.Label(input_frame, text="Angka 1:")
angkal_label.grid(row=0, column=0, sticky="W")
angkal_entry = ttk.Entry(input_frame)
angkal_entry.grid (row=0, column=1)
